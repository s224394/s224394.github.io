...
Since the year 2003 the police department of san francisco has been reporting crime data. All these data are avaible to the public and therefore relevant to do data analysis on. Of particular interest for data analysis is the different crime types, the time of incident (both date but also time of day down to the minute) but also the coordinates of the incident (given in latitude/longitude). From this data its possible to look at temporal and spatial trends of different crimes over the last 20+ years. The different categories of crimes include vehicle theft, vandalism, robbery, prostiution and many more. 
...
One thing that seems unique is the sudden drop from 2005 to 2006 and onwards. In 2005 the numbers peak at around 17.500 vehicle thefts while the next year it drops by around 10.000 and remains in that range going forward. This is approximately 60% of the crimes that just stopped happening in one year. One would suspect that the police force might have increased the resoruces for fighting vehicle theft. One explanation could also be that cars generally are harder to break into today. 

In the news article "Car Thefts Decrease Statewide" by east bay times [@carTheftsDecrease2007] also tells this story
